...
Page({
  data: {
    ...
    //排序
    orderArr: ["按时间排序", "价格从高到低", "价格从低到高", "车龄最短", "里程最少", ],
    showorder: false,
    orderNum: 0,
  ...
  fetchData: function (page) {
    ...
    wx.request({
      url: URL,
      // url:"https://www.hx2car.com.cn/wap/getMoreCar.json",
      data: data,
      header: {
  ...
  firstyear: function (e) {
    this.setData({
      firstyear: Number(e.detail.value)
    })
  },

  lastyear: function (e) {
    this.setData({
      lastyear: Number(e.detail.value)
    })
  },
  setyear: function () {
    var y1 = this.data.firstyear;
    var y2 = this.data.lastyear;
    this.shaixuan();
    var othermap = this.data.othermap;
  ...
  setmileage: function () {
    var m1 = this.data.firstmileage;
    var m2 = this.data.lastmileage;
    this.shaixuan();
    var othermap = this.data.othermap;
