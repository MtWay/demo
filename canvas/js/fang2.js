...
(function() {
    ...
    var scr, canvas, cubes, faces, nx, ny, nw, nh, xm = 0,
        ...
        cxb = 0,
        cyb = 0;
    var white, alpha, fps = 0,
        ncube, npoly, faceOver, drag, moved, startX = 0,
        startY = 0;
    ...
    var Point = function(parent, xyz, project) {
        ...
        this.project = project; //一个标记 true || false
        this.xo = xyz[0];
        this.yo = xyz[1];
        this.zo = xyz[2];
        this.cube = parent;
    ...
    var init = function() {
            ...
            scr.ontouchstart = scr.onmousedown = function(e) {//点击交互
            ...
            scr.ontouchmove = scr.onmousemove = function(e) {//拖动交互
                if (!running) return true;
                // ---- touchmove ---- 
                e.preventDefault();
            ...
            scr.addEventListener('DOMMouseScroll', function(e) {//鼠标滚轮缩放
                if (!running) return true;
                cz += e.detail * 12;
                return false;
            }, false);
            ...
            document.addEventListener('gesturechange', function(e) {//任意手指发生变化
                if (!running) return true;
                e.preventDefault();
                // ---- Z axis rotation ---- 
                cz = event.rotation;
